-- Script para corrigir os tipos de dados das tabelas de analytics já criadas
-- Execute este script para corrigir os tipos UUID para INTEGER onde necessário

-- 1. CORRIGIR TABELA NOTICIAS_ANALYTICS
-- =====================================================

-- Remover constraint de foreign key existente
ALTER TABLE noticias_analytics DROP CONSTRAINT IF EXISTS noticias_analytics_noticia_id_fkey;

-- Criar nova coluna temporária com tipo INTEGER
ALTER TABLE noticias_analytics ADD COLUMN noticia_id_new INTEGER;

-- Copiar dados da coluna antiga para a nova (se houver dados)
-- Como não podemos converter UUID para INTEGER diretamente, vamos limpar a tabela
-- e recriar com o tipo correto
DELETE FROM noticias_analytics;

-- Remover a coluna antiga
ALTER TABLE noticias_analytics DROP COLUMN noticia_id;

-- Renomear a nova coluna
ALTER TABLE noticias_analytics RENAME COLUMN noticia_id_new TO noticia_id;

-- Recriar constraint de foreign key com tipo correto
ALTER TABLE noticias_analytics ADD CONSTRAINT noticias_analytics_noticia_id_fkey 
    FOREIGN KEY (noticia_id) REFERENCES noticias(id) ON DELETE CASCADE;

-- 2. CORRIGIR FUNÇÕES DE NOTÍCIAS
-- =====================================================
...
-- 3. CORRIGIR FUNÇÕES DE TREINAMENTOS
-- =====================================================
